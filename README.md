...
to ensure its stability, but as Amazon provides no official API to use, older versions of this package may break at
any time, so it's recommended that you use the latest version.
