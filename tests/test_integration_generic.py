...
class TestIntegrationGeneric(TestCase):
    ...
    account in question has at least one order in the year INTEGRATION_TEST_YEAR (or it will use the current year).
    The only assertions done are that fields that should be populated are not None.
    """
    amazon_session = None
