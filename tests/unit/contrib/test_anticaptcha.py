...
from amazonorders.contrib.captcha.anticaptcha import AntiCaptchaWafForm
...
class TestAntiCaptchaWafForm(UnitTestCase):
    ...
    def test_init_missing_env_var_raises(self):
        # GIVEN
        prior = os.environ.pop("ANTICAPTCHA_API_KEY", None)
        try:
            # WHEN / THEN
            ...
            if prior is not None:
                os.environ["ANTICAPTCHA_API_KEY"] = prior
